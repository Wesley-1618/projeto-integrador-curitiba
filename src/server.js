...
const routeUsuarioKeyReset = require('./routes/routes_UsuarioKeyReset');
const routeAuth = require('./routes/routes_RecuperacaoSenha');
const routeSimulacao = require('./routes/routes_SimulacaoEmprestimo');
...
app.use(routeUsuarioKeyReset);
app.use(routeAuth);
app.use(routeSimulacao);
